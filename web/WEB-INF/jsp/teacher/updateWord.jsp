...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/updateWord.css">
...
<div class="centent">
    ...
    <div class="right">
        <div class="box">
            <form action="http://localhost:8080/information/word/storeUpdateWord?wordId=${word.wordId}" method="post">
                <div class="one">
                    <span>关键词:</span>
                </div>
                <div class="two">
                    <input type="text" name="wordContent" value="${word.wordContent}">
                </div>
                <div class="three">
                    <span>词汇等级:</span>
                </div>
                ...
                <div class="four">
                    <select name="rank"  placeholder="${word.rank}" class="four">
                ...
                <div class="six">
                    <input type="text" name="count" value="${word.count}">
                </div>
                <div class="seven">
